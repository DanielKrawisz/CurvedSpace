...
type Surface interface {
	...
	// Shift coordinates.
	CoordinateShift(m [][]float64) Surface
	// Translate the surface.
	Translate(x []float64) Surface
	// TODO Conformal map the surface.
	//ConformalMap(a_old, a_new, b_old, b_new, c_old, c_new []float64) Surface
